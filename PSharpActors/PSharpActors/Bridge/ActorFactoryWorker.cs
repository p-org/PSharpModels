...
//            if (this.ReturnProxyIfExists(this.ReceivedEvent as ActorFactory.CreateProxyEvent))
//            {
//                return;
//            }
...
//            this.AddToProxyMap(actorId, proxy);
...
//        protected abstract bool ReturnProxyIfExists(ActorFactory.CreateProxyEvent createEvent);

//        protected abstract void AddToProxyMap(object id, object proxy);
