...
namespace Orleans.Collections
{
    ...
    public interface IContainerNodeGrain<T> : IGrainWithGuidKey, ICollectionOperations<T>, IBatchItemAdder<T>, IElementExecutor<T>, IStreamProcessorNodeGrain<T, ContainerHostedElement<T>>
    {
        /// <summary>
